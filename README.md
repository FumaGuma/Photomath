...
First are the open CV image processing tools which are located in <code>imageproc.py</code>. Pass the image of the equation to the <code>imageproc.cropped_dataset</code> to get the array of cropped symbols. 
