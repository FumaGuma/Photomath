...
First are the open CV image processing tools which are located in imageproc.py. Pass the image of the equation to the <code>imageproc.cropped_dataset</code> to get the array of cropped symbols. 
